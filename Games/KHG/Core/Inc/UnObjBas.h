...
public:
	...
	// UObject interface.
	virtual void ProcessEvent( UFunction* Function, void* ); // void* Parms or void* Result=NULL
	...
	virtual void ProcessInternal( FFrame& TheStack );
	virtual void Modify();
	...
	static UBOOL SavePackage( UObject* InOuter, UObject* Base, DWORD TopLevelFlags, const TCHAR* Filename, INT );
	...
	#define DECLARE_FUNCTION(func) void func( FFrame& TheStack, BYTE*& Result );
