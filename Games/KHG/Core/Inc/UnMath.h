...
inline DWORD FNextPowerOfTwo( DWORD N )
{
	...
	if (N<=524288L  ) return 524288L;
	if (N<=1048576L ) return 1048576L;
	else			  return 0;
}
...
// ~
//
inline DWORD appCeilLogTwo( DWORD N )
{
	if (N<1L		   ) return 0L;
	if (N<2L		   ) return 1L;
	if (N<4L		   ) return 2L;
	...
	if (N<256L     ) return 8L;
	if (N<512L     ) return 9L;
	if (N<1024L    ) return 10L;
	if (N<2048L    ) return 11L;
	if (N<4096L    ) return 12L;
	if (N<8192L    ) return 13L;
	if (N<16384L   ) return 14L;
	if (N<32768L   ) return 15L;
	if (N<65536L   ) return 16L;
	if (N<131072L  ) return 17L;
	if (N<262144L  ) return 18L;
	if (N<524288L  ) return 19L;
	if (N<1048576L ) return 20L;
	else			  return 1;
}
