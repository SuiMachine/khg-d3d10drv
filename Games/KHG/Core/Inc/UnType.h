...
class CORE_API UProperty : public UField
{
	...
	virtual void ExportCpp( FArchive& Ar, UBOOL IsLocal, UBOOL IsParm );
	virtual void ExportCppItem( FArchive& Ar ) const=0;
	...
	virtual void ExecLet( void *, FFrame& Stack );
	virtual UBOOL Port();
	virtual BYTE GetID();
...
class CORE_API UByteProperty : public UProperty
{
	...
	*/
	...
	void ExportCppItem( FArchive& Ar ) const;
...
class CORE_API UStringProperty : public UProperty
{
	...
	{}
	*/
	UStringProperty( ECppProperty, INT InOffset, const TCHAR* InCategory, DWORD InFlags );
	/*
	:	UProperty( EC_CppProperty, InOffset, InCategory, InFlags )
	{}
	*/
