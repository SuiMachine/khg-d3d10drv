...
struct ENGINE_API FSceneNode
{
	...
	FLOAT			RZoom;			// Reverve Zoom value.
...
class ENGINE_API URenderBase : public USubsystem
{
	...
	virtual void Draw2DClippedLine( FSceneNode* Frame, FPlane Color, DWORD LineFlags, FVector Start, FVector End )=0;
	virtual void Draw3DLine( FSceneNode* Frame, FPlane Color, DWORD LineFlags, FVector Start, FVector End )=0;
